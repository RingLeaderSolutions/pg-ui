...
class CreateAccountDialog extends React.Component<CreateAccountDialogProps & StateProps & DispatchProps, {}> {
    ...
    incorporationDate: HTMLInputElement;
    ...
    createAccount(){
        var account: Account = {
            ...
            companyRegistrationNumber: this.companyName.value,
            address: this.address.value,
            postcode: this.postcode.value,
            countryOfOrigin: this.country.value,
            incorporationDate: this.incorporationDate.value,
                    ...
                    <div className="uk-margin">
                        <form>
                            <fieldset className="uk-fieldset">
                                ...
                                <div className='uk-margin'>
                                    <label className='uk-form-label'>Incorporation Date</label>
                                    <input 
                                        className='uk-input' 
                                        type='text' 
                                        ref={ref => this.incorporationDate = ref} />
                                </div>
                                <div className='uk-margin'>
